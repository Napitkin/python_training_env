...
class CreateUser(unittest.TestCase):
    ...
    def create_user(self, wd, first_name, middle_name, nick_name, title, company, address, tel_home, tel_mobile, tel_work, email, b_day, b_month, b_year, anniversary_day, anniversary_month,
                    anniversary_year):
        # fill user form
    ...
    def test_create_user(self):
        ...
        self.create_user(wd, "Kirill", "Napitkin", "Napitkin2", "Da", "Rus_Company", "Moscow Kremlin str.",
